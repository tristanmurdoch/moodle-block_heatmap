...
$string['totaldistinctusers'] = '<em>Distinct users:</em> {$a}';
...
$string['sincecoursestart-date'] = 'Since course start date: {$a}';
...
$string['sincestart-date'] = 'Since course start date with date display';
...
$string['export_data_task'] = 'Heatmap export data job';
$string['true'] = 'True';
$string['false'] = 'False';
$string['checkfortemptable'] = 'Use temp table';
$string['checkfortemptable_help'] = 'Use table to cache log data. Reduce load time. Set scheduled job time to suit/';
$string['student_reporting_enabled'] = 'Enable';
$string['student_reporting_disabled'] = 'Disable';
$string['displayblockviews'] = 'Display total views in block';
$string['displayblockviews_help'] = '';
$string['displaydistinctusers'] = 'Display distinct users in block';
$string['displaydistinctusers_help'] = '';
$string['displaydistinctuserviews'] = 'Display distinct user views in block';
$string['displaydistinctuserviews_help'] = '';
